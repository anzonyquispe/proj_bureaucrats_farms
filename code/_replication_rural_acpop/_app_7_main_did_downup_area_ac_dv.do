...
estwrite eq* using "${root}/tex/paper/tables/_app_7_main_did_downup_area_ac_dv${sample}_rural_acpop.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_7_main_did_downup_area_ac_dv${sample}_rural_acpop.ster"
