...
estwrite evreg* using "${root}/tex/paper/tables/_main_5_polischar_fe12_did_downup_inter${sample}_rural_acpop.ster", replace

display "Ster: ${root}/tex/paper/tables/_main_5_polischar_fe12_did_downup_inter${sample}_rural_acpop.ster"
