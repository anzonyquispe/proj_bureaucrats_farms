...
estwrite evreg* using "${root}/tex/paper/tables/_app_15_polischar_fe12_did${sample}_rural_acpop.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_15_polischar_fe12_did${sample}_rural_acpop.ster"
