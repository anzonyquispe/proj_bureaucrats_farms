...
* 3 columns: 3 FE specs (baseline only, no downup_ac_pop interaction)
********************************************************************************
...
estwrite evreg* using "${root}/tex/paper/tables/_app_14_polischar_fe12_did_ricemods${sample}_rural_acpop.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_14_polischar_fe12_did_ricemods${sample}_rural_acpop.ster"
