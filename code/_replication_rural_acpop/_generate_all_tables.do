...
* Generates LaTeX tables from _rural_acpop.ster files - RURAL GRIDS, downup_ac_pop
...
********************************************************************************
est clear
estread using "${tables}/main_did_downup_area_ac${sample}_rural_acpop.ster"
...
********************************************************************************
est clear
estread using "${tables}/_main_3_bureau_polisc_did${sample}_rural_acpop.ster"
...
********************************************************************************
est clear
estread using "${tables}/_app_7_main_did_downup_area_ac_dv${sample}_rural_acpop.ster"
...
********************************************************************************
est clear
estread using "${tables}/_app_8_main_did_by_year${sample}_rural_acpop.ster"
...
********************************************************************************
est clear
estread using "${tables}/_app_9_main_did_by_state${sample}_rural_acpop.ster"
_strip_zeros_stats, models(eq1 eq2 eq3 eq4) stats(ymean)
...
********************************************************************************
est clear
estread using "${tables}/_app_10_did_rice_moderators${sample}_rural_acpop.ster"
...
********************************************************************************
est clear
estread using "${tables}/_app_20_did_downwind_hm_${sample}_rural_acpop.ster"
_strip_zeros_stats, models(eq1 eq2 eq3 eq4) stats(ymean)
