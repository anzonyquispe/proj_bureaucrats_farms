    ...
    * (year == yr & month >= 9) | (year == yr+1 & month <= 8)
    ...
    preserve
		...
		* Calculate mean DV for this year
		summarize countk if treat == 1 & downup_ac_pop == 0
...
estwrite eq* using "${root}/tex/paper/tables/_app_8_main_did_by_year${sample}_rural_acpop.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_8_main_did_by_year${sample}_rural_acpop.ster"
