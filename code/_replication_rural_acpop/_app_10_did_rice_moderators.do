...
estwrite eq* using "${root}/tex/paper/tables/_app_10_did_rice_moderators${sample}_rural_acpop.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_10_did_rice_moderators${sample}_rural_acpop.ster"
