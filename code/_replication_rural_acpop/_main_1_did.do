...
reg countk downup_ac_pop $controls, vce(cluster grid_id)
...
estwrite eq1 eq2 eq3 eq4 using "${table_farms}/main_did_downup_area_ac${sample}_rural_acpop.ster", replace

display "Estimates saved to: ${table_farms}/main_did_downup_area_ac${sample}_rural_acpop.ster"
