...
estwrite eq* using "${root}/tex/paper/tables/_app_9_main_did_by_state${sample}_rural_acpop.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_9_main_did_by_state${sample}_rural_acpop.ster"
