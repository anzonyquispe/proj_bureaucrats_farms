...
estwrite evreg* using "${root}/tex/paper/tables/_app_18_protest_5km_fe12_did_downup_plot${sample}_rural_acpop.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_18_protest_5km_fe12_did_downup_plot${sample}_rural_acpop.ster"
