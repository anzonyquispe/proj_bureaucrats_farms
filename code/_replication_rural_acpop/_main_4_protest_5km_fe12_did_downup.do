...
* 6 columns: 3 FE specs × 2 moderator types (baseline + downup_ac_pop)
********************************************************************************
...
estwrite evreg* using "${root}/tex/paper/tables/_main_4_protest_5km_fe12_did_downup${sample}_rural_acpop.ster", replace

display "Ster: ${root}/tex/paper/tables/_main_4_protest_5km_fe12_did_downup${sample}_rural_acpop.ster"
