...
estwrite eq* using "${root}/tex/paper/tables/_app_9_main_did_by_state${sample}_rural${ster_suffix}.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_9_main_did_by_state${sample}_rural${ster_suffix}.ster"
