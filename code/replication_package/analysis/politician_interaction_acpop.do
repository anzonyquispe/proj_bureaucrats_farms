...
estwrite evreg* using "${root}/tex/paper/tables/_app_19_polischar_fe12_did_downup_inter_plot${sample}_rural${ster_suffix}.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_19_polischar_fe12_did_downup_inter_plot${sample}_rural${ster_suffix}.ster"
