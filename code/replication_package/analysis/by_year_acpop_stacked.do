...
estwrite eq* using "${root}/tex/paper/tables/_app_8_main_did_by_year${sample}_rural${ster_suffix}.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_8_main_did_by_year${sample}_rural${ster_suffix}.ster"
