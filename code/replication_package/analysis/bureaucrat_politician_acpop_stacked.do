...
estwrite eq1 eq2 eq3 eq4 eq5 using "${table_farms}/_main_3_bureau_polisc_did${sample}_rural${ster_suffix}.ster", replace

display "Estimates saved to: ${table_farms}/_main_3_bureau_polisc_did${sample}_rural${ster_suffix}.ster"
