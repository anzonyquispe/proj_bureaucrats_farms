...
estwrite eq* using "${root}/tex/paper/tables/_app_11_placebo_pop_13km${sample}_rural${ster_suffix}.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_11_placebo_pop_13km${sample}_rural${ster_suffix}.ster"
