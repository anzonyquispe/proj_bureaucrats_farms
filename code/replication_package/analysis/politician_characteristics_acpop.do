...
bys unique_small_grid_id: egen TREAT_down = max(downup_ac_pop)
gen moderator = 0
...
*-------------------------------------
* 4. Loop over filters Ãƒâ€” outcomes
*-------------------------------------
...
foreach mod of local moderators_list{
	...
	* Select FE spec
	foreach feval of numlist $fe_list {
...
estwrite evreg* using "${root}/tex/paper/tables/_main_5_polischar_fe12_did_downup_inter${sample}_rural${ster_suffix}.ster", replace

display "Ster: ${root}/tex/paper/tables/_main_5_polischar_fe12_did_downup_inter${sample}_rural${ster_suffix}.ster"
