********************************************************************************
* Population-weighted stacked event study, five pre-treatment periods
********************************************************************************
...
use "${int_data}/combined_dt_pop.dta", clear
...
estwrite evreg* using "${tables}/stacked_event_study_pop_5pre${sample}_rural${ster_suffix}.ster", replace
estsave_csv evreg1 evreg2 using "${tables}/stacked_event_study_pop_5pre${sample}_rural${ster_suffix}.csv", replace
