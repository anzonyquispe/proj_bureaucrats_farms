...
estwrite evreg* using "${root}/tex/paper/tables/_app_12_protest_5km_fe_did${sample}_rural${ster_suffix}.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_12_protest_5km_fe_did${sample}_rural${ster_suffix}.ster"
