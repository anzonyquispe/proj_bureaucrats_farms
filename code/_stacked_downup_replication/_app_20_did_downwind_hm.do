...
estwrite eq1 eq2 eq3 eq4 using "${table_farms}/_app_20_did_downwind_hm_rural_stacked.ster", replace

display "Estimates saved to: ${table_farms}/_app_20_did_downwind_hm_rural_stacked.ster"
