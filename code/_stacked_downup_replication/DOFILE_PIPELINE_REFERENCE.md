...
| `_app_17_5km_fe12_evst_all.do` | Canonical pooled-control protest event study. Uses the RA's `stacked_data_protest5km_election_sameterm.csv`, estimates selected FE3 plus event-year × cohort FE, and checks the result against the RA benchmark. | `tables/_app_17_5km_fe12_evst_all_rural.ster` and `.csv` |
