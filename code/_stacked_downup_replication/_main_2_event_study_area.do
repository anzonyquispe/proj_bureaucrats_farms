...
estwrite evreg* using "${code}/../../tables/main_event_study${sample}_rural_area_stacked.ster", replace
estsave_csv evreg1  evreg2  evreg3  evreg4 using "${code}/../../tables/main_event_study${sample}_rural_stacked.csv", replace
