...
foreach mod of local moderators_list{
	...
	* Compute mean of dep var where untreated (pr_cl_tr==0)
	...
	quietly summarize `dep_var' if `fcond' & treat==0 & moderator == 0 & TREAT_down == 1 & relative_year_bin < 0
	local ymean2 = r(mean)
...
estwrite evreg* using "${root}/tex/paper/tables/_main_5_polischar_fe12_did_downup_inter${sample}_rural_stacked.ster", replace

display "Ster: ${root}/tex/paper/tables/_main_5_polischar_fe12_did_downup_inter${sample}_rural_stacked.ster"
