...
estwrite eq* using "${root}/tex/paper/tables/_app_8_main_did_by_year_rural_stacked.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_8_main_did_by_year_rural_stacked.ster"
