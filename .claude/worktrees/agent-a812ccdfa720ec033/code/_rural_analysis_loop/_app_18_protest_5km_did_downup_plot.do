********************************************************************************
* _app_18_protest_5km_did_downup_plot_rural.do
* Protest DiD analysis with downup_ac interaction - RURAL GRIDS ONLY
...
foreach fe of numlist $fe_list {
    ...
    * Run regression with clustering
    reghdfejl `dep_var' `rhs', absorb(`fespec') cluster(ac_area_tr)
...
estwrite evreg* using "${root}/tex/paper/tables/_app_18_protest_5km_did_downup_plot${sample}_rural${ster_suffix}.ster", replace

display "Ster: ${root}/tex/paper/tables/_app_18_protest_5km_did_downup_plot${sample}_rural${ster_suffix}.ster"
